...
<a id="hidden-folders">1</a>: If the `.vscode` folder isn't showing, press `Shift` + `⌘` + `.` to show your hidden folders. [↩](#hidden-folders-back)
